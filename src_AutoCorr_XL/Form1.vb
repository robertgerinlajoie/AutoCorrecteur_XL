...
Public Class Form1
    ...
    Private Sub btnDossier_Click(ByVal sender As Object, ByVal e As EventArgs) _
    ...
    Private Sub btnFichier_Click(ByVal sender As Object, _
    ...
    Private Sub btnCorr_Click(ByVal sender As System.Object, _
...
Fin:
    ...
    Private Sub Corriger()
        ...
        With xlFeuilleCorr
            ...
            .Cells(NoLigne, 4).value = "Questions"
            NoLigne += 1
            For Each UnNom As clZone In MaCollCorr
                ...
                ValDiff = Identic(UnRangeEtud, UnRangeMod, 0.0001) = "VS"
                For NumDir As Integer = 1 To NbDir - 2 Step 2

                    If Directive.Contains("V") And ValDiff Then
                        NoLigne += 1
                    ...
                    If Directive.Contains("A") Then
                        If Not OKFont(UnRangeEtud, UnRangeMod) Then
                            NoLigne += 1
                            LaCell = "E" & NoLigne.ToString
                    ...
                    Dim ErreurF As Boolean = False
                    If Directive.Contains("F") Then
                        If ErrVal Or UnRangeEtud.Formula.ToString = "" Then
                            ErreurF = True
                            NoLigne += 1
                            LaCell = "E" & NoLigne.ToString
    ...
    Private Sub LectureComm()
        Dim UnclZone As clZone
